...
void* OPS_IGAQuad()
{
    ...
    return new IGAQuad(idata[0],idata[1],idata[2],idata[3],idata[4],
...
double IGAQuad::matrixData[64];
Matrix IGAQuad::K(matrixData, 8, 8);
Vector IGAQuad::P(8);
double IGAQuad::shp[3][4];
double IGAQuad::pts[4][2];
double IGAQuad::wts[4];

IGAQuad::IGAQuad(int tag, int nd1, int nd2, int nd3, int nd4,
